$(function() {
	...
	findShopList = function(){
		...
		$.ajax({
			url : contextPath + "/shop/shop/findShopList",
			data :o,
			dataType : 'json',
			type : 'post',
	...
	deleteData = function(e){
		...
		$.ajax({
			url : contextPath + "/shop/shop/delete/"+id,
			dataType : 'json',
			type : 'post',
			success : function(data, textStatus, jqXHR) {
				findShopList();
	...
	updateData = function(e){
		...
		if(address != "undefined"){
			$('#updateForm #address').val(address);
		}
	...
	$('#update').click(function() {
		var loginForm = $("#updateForm").serialize();
			$.ajax({
				url : contextPath + "/shop/shop/update",
				data :loginForm,
				dataType : 'json',
				type : 'post',
				success : function(data, textStatus, jqXHR) {
	...
	$('#insert').click(function() {
		...
		$.ajax({
			url : contextPath + "/shop/shop/insert",
			data :loginForm,
			dataType : 'json',
			type : 'post',
			success : function(data, textStatus, jqXHR) {
